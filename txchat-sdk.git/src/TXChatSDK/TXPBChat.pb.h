...
#define FetchChildBindCardRequest_userCards @"userCards"
@interface TXPBFetchChildBindCardRequest : PBGeneratedMessage<GeneratedMessageProtocol> {
@private
  NSMutableArray * userCardsArray;
}
@property (readonly, strong) NSArray * userCards;
...
@interface TXPBFetchChildBindCardRequestBuilder : PBGeneratedMessageBuilder {
@private
  TXPBFetchChildBindCardRequest* resultFetchChildBindCardRequest;
}
