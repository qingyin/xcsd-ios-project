...
//开发测试服--1；正式服，提审上线的---0
//且与 #define DEV_TEST 一致
#define DEV_TEST_POD 1

#if DEV_TEST_POD
	//开发服
	#define TX_CHAT_SERVER_ENDPOINT                 @"http://121.40.16.212:8080/http_invoke"
	////测试服
//	#define TX_CHAT_SERVER_ENDPOINT               @"http://121.41.101.14:8080/http_invoke"
#else
	//正式服
	#define TX_CHAT_SERVER_ENDPOINT                 @"http://service.xcsdedu.com/http_invoke"
#endif
...
#define TX_COUNT_HOMEWORK                                 @"homework"           //作业
...
#define TX_LAST_FETCHED_ON_DEPARTMENT_MEMBER            @"lastFetchedOn.departmen/Users/gaoju/Desktop/ios/txchat-parent.git/src/TXChatParent.xcodeprojtMember"
...
#define TX_PROFILE_KEY_OPTION_GAME                      @"game" //by mey
#define TX_PROFILE_KEY_OPTION_HOMEWORK                  @"homework" //作业
#define TX_PROFILE_KEY_OPTION_ACHIEVEMENT               @"achievement" //学能成绩
#define TX_PROFILE_KEY_OPTION_THEME_TEST                @"themeTest" //主题测试
#define TX_PROFILE_KEY_OPTION_THEME_COURSE              @"course"    // 空中课堂

#define XCSD_PROFILE_KEY_OPTION_STUDENTSEFATY               @"studententsefaty" // 学生安全
...
#if DEV_TEST_POD
	#define TX_QINIU_DOMAIN                             @"http://o7m2r7gaj.bkt.clouddn.com"
#else
	#define TX_QINIU_DOMAIN                             @"http://resource.xcsdedu.com"
#endif
