...
static tx_sql_t sql_table[] = {
    ...
    {24,"CREATE TABLE homeWork("
        ...
        "UNIQUE (homeWorkId,memberId) ON CONFLICT REPLACE"
        ")"
    },
    
    {25, "ALTER TABLE user ADD COLUMN custom_name TEXT DEFAULT ''"},
    {26, "ALTER TABLE department_user ADD COLUMN depart_nickname TEXT NOT NULL DEFAULT ''"},
    {27, "ALTER TABLE department_user ADD COLUMN depart_nickname_first_letter TEXT NOT NULL DEFAULT ''"},
    {28, "CREATE TABLE user_relation ("
        "updated_on             INTEGER NOT NULL,"
        "created_on             INTEGER NOT NULL,"
    ...
    {29, "ALTER TABLE qr_check_in_item ADD COLUMN target_child_id INTEGER NOT NULL DEFAULT 0"},
    {30, "ALTER TABLE user ADD COLUMN combined_nick_name TEXT DEFAULT ''"},
    {31, "ALTER TABLE feed_medicine_task ADD COLUMN child_name TEXT DEFAULT ''"},
    {32, "ALTER TABLE feed_medicine_task ADD COLUMN child_avatar TEXT DEFAULT ''"},
...
- (void)registerDaoWithDatabaseQueue:(FMDatabaseQueue *)databaseQueue {
    ...
    _homeWorkDao=[[XCSDHomeWorkDao alloc] initWithFMDatabaseQueue:_databaseQueue];
