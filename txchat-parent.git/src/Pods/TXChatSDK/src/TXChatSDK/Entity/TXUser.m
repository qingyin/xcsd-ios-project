...
- (instancetype)loadValueFromFMResultSet:(FMResultSet *)resultSet {
    ...
    if([resultSet.columnNameToIndexMap objectForKey:@"depart_nickname"] != nil)
    {
        _nickname = [resultSet stringForColumn:@"depart_nickname"];
    }
    if([resultSet.columnNameToIndexMap objectForKey:@"depart_nickname_first_letter"] != nil)
    {
        _nicknameFirstLetter = [resultSet stringForColumn:@"depart_nickname_first_letter"];
    }
...
- (instancetype)loadValueFromPbObject:(TXPBUser *)txpbUser {
    ...
    _userType = txpbUser.userType;
    _nickname = txpbUser.combinedNickname;
    ...
    _customName = txpbUser.customName;
    _childUserIdAndRelationsList = txpbUser.childs;
    _combinedNickName = txpbUser.combinedNickname;
