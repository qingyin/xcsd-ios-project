...
@interface XCSDPBHomeworkDetailRequest ()
@property SInt64 memberId;
@end

@implementation XCSDPBHomeworkDetailRequest
...
static XCSDPBHomeworkDetailRequest* defaultXCSDPBHomeworkDetailRequestInstance = nil;
+ (void) initialize {
  if (self == [XCSDPBHomeworkDetailRequest class]) {
    defaultXCSDPBHomeworkDetailRequestInstance = [[XCSDPBHomeworkDetailRequest alloc] init];
  }
}
+ (instancetype) defaultInstance {
  return defaultXCSDPBHomeworkDetailRequestInstance;
}
- (instancetype) defaultInstance {
  return defaultXCSDPBHomeworkDetailRequestInstance;
}
...
+ (XCSDPBHomeworkDetailRequest*) parseFromData:(NSData*) data {
  return (XCSDPBHomeworkDetailRequest*)[[[XCSDPBHomeworkDetailRequest builder] mergeFromData:data] build];
}
+ (XCSDPBHomeworkDetailRequest*) parseFromData:(NSData*) data extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (XCSDPBHomeworkDetailRequest*)[[[XCSDPBHomeworkDetailRequest builder] mergeFromData:data extensionRegistry:extensionRegistry] build];
}
+ (XCSDPBHomeworkDetailRequest*) parseFromInputStream:(NSInputStream*) input {
  return (XCSDPBHomeworkDetailRequest*)[[[XCSDPBHomeworkDetailRequest builder] mergeFromInputStream:input] build];
}
+ (XCSDPBHomeworkDetailRequest*) parseFromInputStream:(NSInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (XCSDPBHomeworkDetailRequest*)[[[XCSDPBHomeworkDetailRequest builder] mergeFromInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (XCSDPBHomeworkDetailRequest*) parseFromCodedInputStream:(PBCodedInputStream*) input {
  return (XCSDPBHomeworkDetailRequest*)[[[XCSDPBHomeworkDetailRequest builder] mergeFromCodedInputStream:input] build];
}
+ (XCSDPBHomeworkDetailRequest*) parseFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (XCSDPBHomeworkDetailRequest*)[[[XCSDPBHomeworkDetailRequest builder] mergeFromCodedInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (XCSDPBHomeworkDetailRequestBuilder*) builder {
  return [[XCSDPBHomeworkDetailRequestBuilder alloc] init];
}
+ (XCSDPBHomeworkDetailRequestBuilder*) builderWithPrototype:(XCSDPBHomeworkDetailRequest*) prototype {
  return [[XCSDPBHomeworkDetailRequest builder] mergeFrom:prototype];
}
- (XCSDPBHomeworkDetailRequestBuilder*) builder {
  return [XCSDPBHomeworkDetailRequest builder];
}
- (XCSDPBHomeworkDetailRequestBuilder*) toBuilder {
  return [XCSDPBHomeworkDetailRequest builderWithPrototype:self];
}
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  if (self.hasMemberId) {
    [output appendFormat:@"%@%@: %@\n", indent, @"memberId", [NSNumber numberWithLongLong:self.memberId]];
...
- (BOOL) isEqual:(id)other {
  ...
  if (![other isKindOfClass:[XCSDPBHomeworkDetailRequest class]]) {
    return NO;
  }
  XCSDPBHomeworkDetailRequest *otherMessage = other;
  return
      self.hasMemberId == otherMessage.hasMemberId &&
      (!self.hasMemberId || self.memberId == otherMessage.memberId) &&
      (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
...
@interface XCSDPBHomeworkDetailRequestBuilder()
@property (strong) XCSDPBHomeworkDetailRequest* resultHomeworkDetailRequest;
@end

@implementation XCSDPBHomeworkDetailRequestBuilder
@synthesize resultHomeworkDetailRequest;
- (instancetype) init {
  if ((self = [super init])) {
    self.resultHomeworkDetailRequest = [[XCSDPBHomeworkDetailRequest alloc] init];
  }
  return self;
}
- (PBGeneratedMessage*) internalGetResult {
  return resultHomeworkDetailRequest;
}
- (XCSDPBHomeworkDetailRequestBuilder*) clear {
  self.resultHomeworkDetailRequest = [[XCSDPBHomeworkDetailRequest alloc] init];
  return self;
}
- (XCSDPBHomeworkDetailRequestBuilder*) clone {
  return [XCSDPBHomeworkDetailRequest builderWithPrototype:resultHomeworkDetailRequest];
}
- (XCSDPBHomeworkDetailRequest*) defaultInstance {
  return [XCSDPBHomeworkDetailRequest defaultInstance];
}
- (XCSDPBHomeworkDetailRequest*) build {
  [self checkInitialized];
  return [self buildPartial];
}
- (XCSDPBHomeworkDetailRequest*) buildPartial {
  XCSDPBHomeworkDetailRequest* returnMe = resultHomeworkDetailRequest;
  self.resultHomeworkDetailRequest = nil;
  return returnMe;
}
- (XCSDPBHomeworkDetailRequestBuilder*) mergeFrom:(XCSDPBHomeworkDetailRequest*) other {
  if (other == [XCSDPBHomeworkDetailRequest defaultInstance]) {
    return self;
  }
  if (other.hasMemberId) {
    [self setMemberId:other.memberId];
...
- (XCSDPBHomeworkDetailRequestBuilder*) mergeFromCodedInputStream:(PBCodedInputStream*) input {
  return [self mergeFromCodedInputStream:input extensionRegistry:[PBExtensionRegistry emptyRegistry]];
}
- (XCSDPBHomeworkDetailRequestBuilder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  PBUnknownFieldSetBuilder* unknownFields = [PBUnknownFieldSet builderWithUnknownFields:self.unknownFields];
  while (YES) {
    SInt32 tag = [input readTag];
    switch (tag) {
...
- (BOOL) hasMemberId {
  return resultHomeworkDetailRequest.hasMemberId;
}
- (SInt64) memberId {
  return resultHomeworkDetailRequest.memberId;
}
- (XCSDPBHomeworkDetailRequestBuilder*) setMemberId:(SInt64) value {
  resultHomeworkDetailRequest.hasMemberId = YES;
  resultHomeworkDetailRequest.memberId = value;
  return self;
}
- (XCSDPBHomeworkDetailRequestBuilder*) clearMemberId {
  resultHomeworkDetailRequest.hasMemberId = NO;
  resultHomeworkDetailRequest.memberId = 0L;
  return self;
}
@end

@interface XCSDPBHomeworkDetailResponse ()
@property SInt64 memberId;
@property XCSDPBHomeworkStatus status;
@property (strong) NSString* title;
...
@property (strong) NSMutableArray * gameLevelsArray;
@property SInt64 sendTime;
@property SInt64 childUserId;
@end

@implementation XCSDPBHomeworkDetailResponse
...
static XCSDPBHomeworkDetailResponse* defaultXCSDPBHomeworkDetailResponseInstance = nil;
+ (void) initialize {
  if (self == [XCSDPBHomeworkDetailResponse class]) {
    defaultXCSDPBHomeworkDetailResponseInstance = [[XCSDPBHomeworkDetailResponse alloc] init];
  }
}
+ (instancetype) defaultInstance {
  return defaultXCSDPBHomeworkDetailResponseInstance;
}
- (instancetype) defaultInstance {
  return defaultXCSDPBHomeworkDetailResponseInstance;
}
...
- (XCSDPBGameLevel*)gameLevelsAtIndex:(NSUInteger)index {
  return [gameLevelsArray objectAtIndex:index];
}
- (BOOL) isInitialized {
  if (!self.hasMemberId) {
    return NO;
  ...
  __block BOOL isInitgameLevels = YES;
   [self.gameLevels enumerateObjectsUsingBlock:^(XCSDPBGameLevel *element, NSUInteger idx, BOOL *stop) {
    if (!element.isInitialized) {
      isInitgameLevels = NO;
      *stop = YES;
    }
  }];
  if (!isInitgameLevels) return isInitgameLevels;
  return YES;
}
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  if (self.hasMemberId) {
  ...
  if (self.hasDescription) {
    [output writeString:4 value:self.pb_description];
  }
  if (self.hasSenderName) {
    [output writeString:5 value:self.senderName];
  }
  if (self.hasTotalScore) {
    [output writeInt32:6 value:self.totalScore];
  }
  if (self.hasMaxScore) {
    [output writeInt32:7 value:self.maxScore];
  }
  [self.gameLevelsArray enumerateObjectsUsingBlock:^(XCSDPBGameLevel *element, NSUInteger idx, BOOL *stop) {
    [output writeMessage:8 value:element];
  }];
  if (self.hasSendTime) {
    [output writeInt64:9 value:self.sendTime];
  }
  if (self.hasChildUserId) {
    [output writeInt64:10 value:self.childUserId];
  }
  [self.unknownFields writeToCodedOutputStream:output];
}
- (SInt32) serializedSize {
  ...
  if (self.hasDescription) {
    size_ += computeStringSize(4, self.pb_description);
  }
  if (self.hasSenderName) {
    size_ += computeStringSize(5, self.senderName);
  }
  if (self.hasTotalScore) {
    size_ += computeInt32Size(6, self.totalScore);
  }
  if (self.hasMaxScore) {
    size_ += computeInt32Size(7, self.maxScore);
  }
  [self.gameLevelsArray enumerateObjectsUsingBlock:^(XCSDPBGameLevel *element, NSUInteger idx, BOOL *stop) {
    size_ += computeMessageSize(8, element);
  }];
  if (self.hasSendTime) {
    size_ += computeInt64Size(9, self.sendTime);
  }
  if (self.hasChildUserId) {
    size_ += computeInt64Size(10, self.childUserId);
  }
  size_ += self.unknownFields.serializedSize;
  memoizedSerializedSize = size_;
  return size_;
}
+ (XCSDPBHomeworkDetailResponse*) parseFromData:(NSData*) data {
  return (XCSDPBHomeworkDetailResponse*)[[[XCSDPBHomeworkDetailResponse builder] mergeFromData:data] build];
}
+ (XCSDPBHomeworkDetailResponse*) parseFromData:(NSData*) data extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (XCSDPBHomeworkDetailResponse*)[[[XCSDPBHomeworkDetailResponse builder] mergeFromData:data extensionRegistry:extensionRegistry] build];
}
+ (XCSDPBHomeworkDetailResponse*) parseFromInputStream:(NSInputStream*) input {
  return (XCSDPBHomeworkDetailResponse*)[[[XCSDPBHomeworkDetailResponse builder] mergeFromInputStream:input] build];
}
+ (XCSDPBHomeworkDetailResponse*) parseFromInputStream:(NSInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (XCSDPBHomeworkDetailResponse*)[[[XCSDPBHomeworkDetailResponse builder] mergeFromInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (XCSDPBHomeworkDetailResponse*) parseFromCodedInputStream:(PBCodedInputStream*) input {
  return (XCSDPBHomeworkDetailResponse*)[[[XCSDPBHomeworkDetailResponse builder] mergeFromCodedInputStream:input] build];
}
+ (XCSDPBHomeworkDetailResponse*) parseFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (XCSDPBHomeworkDetailResponse*)[[[XCSDPBHomeworkDetailResponse builder] mergeFromCodedInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (XCSDPBHomeworkDetailResponseBuilder*) builder {
  return [[XCSDPBHomeworkDetailResponseBuilder alloc] init];
}
+ (XCSDPBHomeworkDetailResponseBuilder*) builderWithPrototype:(XCSDPBHomeworkDetailResponse*) prototype {
  return [[XCSDPBHomeworkDetailResponse builder] mergeFrom:prototype];
}
- (XCSDPBHomeworkDetailResponseBuilder*) builder {
  return [XCSDPBHomeworkDetailResponse builder];
}
- (XCSDPBHomeworkDetailResponseBuilder*) toBuilder {
  return [XCSDPBHomeworkDetailResponse builderWithPrototype:self];
}
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  if (self.hasMemberId) {
    [output appendFormat:@"%@%@: %@\n", indent, @"memberId", [NSNumber numberWithLongLong:self.memberId]];
...
- (void) storeInDictionary:(NSMutableDictionary *)dictionary {
  ...
  for (XCSDPBGameLevel* element in self.gameLevelsArray) {
    NSMutableDictionary *elementDictionary = [NSMutableDictionary dictionary];
    [element storeInDictionary:elementDictionary];
    [dictionary setObject:[NSDictionary dictionaryWithDictionary:elementDictionary] forKey:@"gameLevels"];
  }
  if (self.hasSendTime) {
    [dictionary setObject: [NSNumber numberWithLongLong:self.sendTime] forKey: @"sendTime"];
  }
...
- (BOOL) isEqual:(id)other {
  ...
  if (![other isKindOfClass:[XCSDPBHomeworkDetailResponse class]]) {
    return NO;
  }
  XCSDPBHomeworkDetailResponse *otherMessage = other;
  return
      self.hasMemberId == otherMessage.hasMemberId &&
      (!self.hasMemberId || self.memberId == otherMessage.memberId) &&
      self.hasStatus == otherMessage.hasStatus &&
      ...
      [self.gameLevelsArray isEqualToArray:otherMessage.gameLevelsArray] &&
      self.hasSendTime == otherMessage.hasSendTime &&
      (!self.hasSendTime || self.sendTime == otherMessage.sendTime) &&
      self.hasChildUserId == otherMessage.hasChildUserId &&
      (!self.hasChildUserId || self.childUserId == otherMessage.childUserId) &&
...
@interface XCSDPBHomeworkDetailResponseBuilder()
@property (strong) XCSDPBHomeworkDetailResponse* resultHomeworkDetailResponse;
@end

@implementation XCSDPBHomeworkDetailResponseBuilder
@synthesize resultHomeworkDetailResponse;
- (instancetype) init {
  if ((self = [super init])) {
    self.resultHomeworkDetailResponse = [[XCSDPBHomeworkDetailResponse alloc] init];
  }
  return self;
}
- (PBGeneratedMessage*) internalGetResult {
  return resultHomeworkDetailResponse;
}
- (XCSDPBHomeworkDetailResponseBuilder*) clear {
  self.resultHomeworkDetailResponse = [[XCSDPBHomeworkDetailResponse alloc] init];
  return self;
}
- (XCSDPBHomeworkDetailResponseBuilder*) clone {
  return [XCSDPBHomeworkDetailResponse builderWithPrototype:resultHomeworkDetailResponse];
}
- (XCSDPBHomeworkDetailResponse*) defaultInstance {
  return [XCSDPBHomeworkDetailResponse defaultInstance];
}
- (XCSDPBHomeworkDetailResponse*) build {
  [self checkInitialized];
  return [self buildPartial];
}
- (XCSDPBHomeworkDetailResponse*) buildPartial {
  XCSDPBHomeworkDetailResponse* returnMe = resultHomeworkDetailResponse;
  self.resultHomeworkDetailResponse = nil;
  return returnMe;
}
- (XCSDPBHomeworkDetailResponseBuilder*) mergeFrom:(XCSDPBHomeworkDetailResponse*) other {
  if (other == [XCSDPBHomeworkDetailResponse defaultInstance]) {
    return self;
  }
  if (other.hasMemberId) {
    [self setMemberId:other.memberId];
  ...
  if (other.gameLevelsArray.count > 0) {
    if (resultHomeworkDetailResponse.gameLevelsArray == nil) {
      resultHomeworkDetailResponse.gameLevelsArray = [[NSMutableArray alloc] initWithArray:other.gameLevelsArray];
    } else {
      [resultHomeworkDetailResponse.gameLevelsArray addObjectsFromArray:other.gameLevelsArray];
    }
  }
  if (other.hasSendTime) {
    [self setSendTime:other.sendTime];
...
- (XCSDPBHomeworkDetailResponseBuilder*) mergeFromCodedInputStream:(PBCodedInputStream*) input {
  return [self mergeFromCodedInputStream:input extensionRegistry:[PBExtensionRegistry emptyRegistry]];
}
- (XCSDPBHomeworkDetailResponseBuilder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  PBUnknownFieldSetBuilder* unknownFields = [PBUnknownFieldSet builderWithUnknownFields:self.unknownFields];
  while (YES) {
    SInt32 tag = [input readTag];
    switch (tag) {
      ...
      case 66: {
        ...
        [input readMessage:subBuilder extensionRegistry:extensionRegistry];
        [self addGameLevels:[subBuilder buildPartial]];
        break;
      }
      case 72: {
        [self setSendTime:[input readInt64]];
...
- (BOOL) hasMemberId {
  return resultHomeworkDetailResponse.hasMemberId;
}
- (SInt64) memberId {
  return resultHomeworkDetailResponse.memberId;
}
- (XCSDPBHomeworkDetailResponseBuilder*) setMemberId:(SInt64) value {
  resultHomeworkDetailResponse.hasMemberId = YES;
  resultHomeworkDetailResponse.memberId = value;
  return self;
}
- (XCSDPBHomeworkDetailResponseBuilder*) clearMemberId {
  resultHomeworkDetailResponse.hasMemberId = NO;
  resultHomeworkDetailResponse.memberId = 0L;
  return self;
}
- (BOOL) hasStatus {
  return resultHomeworkDetailResponse.hasStatus;
}
- (XCSDPBHomeworkStatus) status {
  return resultHomeworkDetailResponse.status;
}
- (XCSDPBHomeworkDetailResponseBuilder*) setStatus:(XCSDPBHomeworkStatus) value {
  resultHomeworkDetailResponse.hasStatus = YES;
  resultHomeworkDetailResponse.status = value;
  return self;
}
- (XCSDPBHomeworkDetailResponseBuilder*) clearStatus {
  resultHomeworkDetailResponse.hasStatus = NO;
  resultHomeworkDetailResponse.status = XCSDPBHomeworkStatusUnfinished;
  return self;
}
- (BOOL) hasTitle {
  return resultHomeworkDetailResponse.hasTitle;
}
- (NSString*) title {
  return resultHomeworkDetailResponse.title;
}
- (XCSDPBHomeworkDetailResponseBuilder*) setTitle:(NSString*) value {
  resultHomeworkDetailResponse.hasTitle = YES;
  resultHomeworkDetailResponse.title = value;
  return self;
}
- (XCSDPBHomeworkDetailResponseBuilder*) clearTitle {
  resultHomeworkDetailResponse.hasTitle = NO;
  resultHomeworkDetailResponse.title = @"";
  return self;
}
- (BOOL) hasDescription {
  return resultHomeworkDetailResponse.hasDescription;
}
- (NSString*) pb_description {
  return resultHomeworkDetailResponse.pb_description;
}
- (XCSDPBHomeworkDetailResponseBuilder*) setDescription:(NSString*) value {
  resultHomeworkDetailResponse.hasDescription = YES;
  resultHomeworkDetailResponse.pb_description = value;
  return self;
}
- (XCSDPBHomeworkDetailResponseBuilder*) clearDescription {
  resultHomeworkDetailResponse.hasDescription = NO;
  resultHomeworkDetailResponse.pb_description = @"";
  return self;
}
- (BOOL) hasSenderName {
  return resultHomeworkDetailResponse.hasSenderName;
}
- (NSString*) senderName {
  return resultHomeworkDetailResponse.senderName;
}
- (XCSDPBHomeworkDetailResponseBuilder*) setSenderName:(NSString*) value {
  resultHomeworkDetailResponse.hasSenderName = YES;
  resultHomeworkDetailResponse.senderName = value;
  return self;
}
- (XCSDPBHomeworkDetailResponseBuilder*) clearSenderName {
  resultHomeworkDetailResponse.hasSenderName = NO;
  resultHomeworkDetailResponse.senderName = @"";
  return self;
}
- (BOOL) hasTotalScore {
  return resultHomeworkDetailResponse.hasTotalScore;
}
- (SInt32) totalScore {
  return resultHomeworkDetailResponse.totalScore;
}
- (XCSDPBHomeworkDetailResponseBuilder*) setTotalScore:(SInt32) value {
  resultHomeworkDetailResponse.hasTotalScore = YES;
  resultHomeworkDetailResponse.totalScore = value;
  return self;
}
- (XCSDPBHomeworkDetailResponseBuilder*) clearTotalScore {
  resultHomeworkDetailResponse.hasTotalScore = NO;
  resultHomeworkDetailResponse.totalScore = 0;
  return self;
}
- (BOOL) hasMaxScore {
  return resultHomeworkDetailResponse.hasMaxScore;
}
- (SInt32) maxScore {
  return resultHomeworkDetailResponse.maxScore;
}
- (XCSDPBHomeworkDetailResponseBuilder*) setMaxScore:(SInt32) value {
  resultHomeworkDetailResponse.hasMaxScore = YES;
  resultHomeworkDetailResponse.maxScore = value;
  return self;
}
- (XCSDPBHomeworkDetailResponseBuilder*) clearMaxScore {
  resultHomeworkDetailResponse.hasMaxScore = NO;
  resultHomeworkDetailResponse.maxScore = 0;
  return self;
}
- (NSMutableArray *)gameLevels {
  return resultHomeworkDetailResponse.gameLevelsArray;
}
- (XCSDPBGameLevel*)gameLevelsAtIndex:(NSUInteger)index {
  return [resultHomeworkDetailResponse gameLevelsAtIndex:index];
}
- (XCSDPBHomeworkDetailResponseBuilder *)addGameLevels:(XCSDPBGameLevel*)value {
  if (resultHomeworkDetailResponse.gameLevelsArray == nil) {
    resultHomeworkDetailResponse.gameLevelsArray = [[NSMutableArray alloc]init];
  }
  [resultHomeworkDetailResponse.gameLevelsArray addObject:value];
  return self;
}
- (XCSDPBHomeworkDetailResponseBuilder *)setGameLevelsArray:(NSArray *)array {
  resultHomeworkDetailResponse.gameLevelsArray = [[NSMutableArray alloc]initWithArray:array];
  return self;
}
- (XCSDPBHomeworkDetailResponseBuilder *)clearGameLevels {
  resultHomeworkDetailResponse.gameLevelsArray = nil;
  return self;
}
- (BOOL) hasSendTime {
  return resultHomeworkDetailResponse.hasSendTime;
}
- (SInt64) sendTime {
  return resultHomeworkDetailResponse.sendTime;
}
- (XCSDPBHomeworkDetailResponseBuilder*) setSendTime:(SInt64) value {
  resultHomeworkDetailResponse.hasSendTime = YES;
  resultHomeworkDetailResponse.sendTime = value;
  return self;
}
- (XCSDPBHomeworkDetailResponseBuilder*) clearSendTime {
  resultHomeworkDetailResponse.hasSendTime = NO;
  resultHomeworkDetailResponse.sendTime = 0L;
  return self;
}
- (BOOL) hasChildUserId {
  return resultHomeworkDetailResponse.hasChildUserId;
}
- (SInt64) childUserId {
  return resultHomeworkDetailResponse.childUserId;
}
- (XCSDPBHomeworkDetailResponseBuilder*) setChildUserId:(SInt64) value {
  resultHomeworkDetailResponse.hasChildUserId = YES;
  resultHomeworkDetailResponse.childUserId = value;
  return self;
}
- (XCSDPBHomeworkDetailResponseBuilder*) clearChildUserId {
  resultHomeworkDetailResponse.hasChildUserId = NO;
  resultHomeworkDetailResponse.childUserId = 0L;
  return self;
}
@end

@interface XCSDPBHomeworkGenerateDetailRequest ()
@property SInt64 classId;
@property SInt64 childUserId;
@end

@implementation XCSDPBHomeworkGenerateDetailRequest
...
static XCSDPBHomeworkGenerateDetailRequest* defaultXCSDPBHomeworkGenerateDetailRequestInstance = nil;
+ (void) initialize {
  if (self == [XCSDPBHomeworkGenerateDetailRequest class]) {
    defaultXCSDPBHomeworkGenerateDetailRequestInstance = [[XCSDPBHomeworkGenerateDetailRequest alloc] init];
  }
}
+ (instancetype) defaultInstance {
  return defaultXCSDPBHomeworkGenerateDetailRequestInstance;
}
- (instancetype) defaultInstance {
  return defaultXCSDPBHomeworkGenerateDetailRequestInstance;
}
...
+ (XCSDPBHomeworkGenerateDetailRequest*) parseFromData:(NSData*) data {
  return (XCSDPBHomeworkGenerateDetailRequest*)[[[XCSDPBHomeworkGenerateDetailRequest builder] mergeFromData:data] build];
}
+ (XCSDPBHomeworkGenerateDetailRequest*) parseFromData:(NSData*) data extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (XCSDPBHomeworkGenerateDetailRequest*)[[[XCSDPBHomeworkGenerateDetailRequest builder] mergeFromData:data extensionRegistry:extensionRegistry] build];
}
+ (XCSDPBHomeworkGenerateDetailRequest*) parseFromInputStream:(NSInputStream*) input {
  return (XCSDPBHomeworkGenerateDetailRequest*)[[[XCSDPBHomeworkGenerateDetailRequest builder] mergeFromInputStream:input] build];
}
+ (XCSDPBHomeworkGenerateDetailRequest*) parseFromInputStream:(NSInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (XCSDPBHomeworkGenerateDetailRequest*)[[[XCSDPBHomeworkGenerateDetailRequest builder] mergeFromInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (XCSDPBHomeworkGenerateDetailRequest*) parseFromCodedInputStream:(PBCodedInputStream*) input {
  return (XCSDPBHomeworkGenerateDetailRequest*)[[[XCSDPBHomeworkGenerateDetailRequest builder] mergeFromCodedInputStream:input] build];
}
+ (XCSDPBHomeworkGenerateDetailRequest*) parseFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (XCSDPBHomeworkGenerateDetailRequest*)[[[XCSDPBHomeworkGenerateDetailRequest builder] mergeFromCodedInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (XCSDPBHomeworkGenerateDetailRequestBuilder*) builder {
  return [[XCSDPBHomeworkGenerateDetailRequestBuilder alloc] init];
}
+ (XCSDPBHomeworkGenerateDetailRequestBuilder*) builderWithPrototype:(XCSDPBHomeworkGenerateDetailRequest*) prototype {
  return [[XCSDPBHomeworkGenerateDetailRequest builder] mergeFrom:prototype];
}
- (XCSDPBHomeworkGenerateDetailRequestBuilder*) builder {
  return [XCSDPBHomeworkGenerateDetailRequest builder];
}
- (XCSDPBHomeworkGenerateDetailRequestBuilder*) toBuilder {
  return [XCSDPBHomeworkGenerateDetailRequest builderWithPrototype:self];
}
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  if (self.hasClassId) {
    [output appendFormat:@"%@%@: %@\n", indent, @"classId", [NSNumber numberWithLongLong:self.classId]];
...
- (BOOL) isEqual:(id)other {
  ...
  if (![other isKindOfClass:[XCSDPBHomeworkGenerateDetailRequest class]]) {
    return NO;
  }
  XCSDPBHomeworkGenerateDetailRequest *otherMessage = other;
  return
      self.hasClassId == otherMessage.hasClassId &&
      (!self.hasClassId || self.classId == otherMessage.classId) &&
      self.hasChildUserId == otherMessage.hasChildUserId &&
...
@interface XCSDPBHomeworkGenerateDetailRequestBuilder()
@property (strong) XCSDPBHomeworkGenerateDetailRequest* resultHomeworkGenerateDetailRequest;
@end

@implementation XCSDPBHomeworkGenerateDetailRequestBuilder
@synthesize resultHomeworkGenerateDetailRequest;
- (instancetype) init {
  if ((self = [super init])) {
    self.resultHomeworkGenerateDetailRequest = [[XCSDPBHomeworkGenerateDetailRequest alloc] init];
  }
  return self;
}
- (PBGeneratedMessage*) internalGetResult {
  return resultHomeworkGenerateDetailRequest;
}
- (XCSDPBHomeworkGenerateDetailRequestBuilder*) clear {
  self.resultHomeworkGenerateDetailRequest = [[XCSDPBHomeworkGenerateDetailRequest alloc] init];
  return self;
}
- (XCSDPBHomeworkGenerateDetailRequestBuilder*) clone {
  return [XCSDPBHomeworkGenerateDetailRequest builderWithPrototype:resultHomeworkGenerateDetailRequest];
}
- (XCSDPBHomeworkGenerateDetailRequest*) defaultInstance {
  return [XCSDPBHomeworkGenerateDetailRequest defaultInstance];
}
- (XCSDPBHomeworkGenerateDetailRequest*) build {
  [self checkInitialized];
  return [self buildPartial];
}
- (XCSDPBHomeworkGenerateDetailRequest*) buildPartial {
  XCSDPBHomeworkGenerateDetailRequest* returnMe = resultHomeworkGenerateDetailRequest;
  self.resultHomeworkGenerateDetailRequest = nil;
  return returnMe;
}
- (XCSDPBHomeworkGenerateDetailRequestBuilder*) mergeFrom:(XCSDPBHomeworkGenerateDetailRequest*) other {
  if (other == [XCSDPBHomeworkGenerateDetailRequest defaultInstance]) {
    return self;
  }
  if (other.hasClassId) {
    [self setClassId:other.classId];
...
- (XCSDPBHomeworkGenerateDetailRequestBuilder*) mergeFromCodedInputStream:(PBCodedInputStream*) input {
  return [self mergeFromCodedInputStream:input extensionRegistry:[PBExtensionRegistry emptyRegistry]];
}
- (XCSDPBHomeworkGenerateDetailRequestBuilder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  PBUnknownFieldSetBuilder* unknownFields = [PBUnknownFieldSet builderWithUnknownFields:self.unknownFields];
  while (YES) {
    SInt32 tag = [input readTag];
    switch (tag) {
...
- (BOOL) hasClassId {
  return resultHomeworkGenerateDetailRequest.hasClassId;
}
- (SInt64) classId {
  return resultHomeworkGenerateDetailRequest.classId;
}
- (XCSDPBHomeworkGenerateDetailRequestBuilder*) setClassId:(SInt64) value {
  resultHomeworkGenerateDetailRequest.hasClassId = YES;
  resultHomeworkGenerateDetailRequest.classId = value;
  return self;
}
- (XCSDPBHomeworkGenerateDetailRequestBuilder*) clearClassId {
  resultHomeworkGenerateDetailRequest.hasClassId = NO;
  resultHomeworkGenerateDetailRequest.classId = 0L;
  return self;
}
- (BOOL) hasChildUserId {
  return resultHomeworkGenerateDetailRequest.hasChildUserId;
}
- (SInt64) childUserId {
  return resultHomeworkGenerateDetailRequest.childUserId;
}
- (XCSDPBHomeworkGenerateDetailRequestBuilder*) setChildUserId:(SInt64) value {
  resultHomeworkGenerateDetailRequest.hasChildUserId = YES;
  resultHomeworkGenerateDetailRequest.childUserId = value;
  return self;
}
- (XCSDPBHomeworkGenerateDetailRequestBuilder*) clearChildUserId {
  resultHomeworkGenerateDetailRequest.hasChildUserId = NO;
  resultHomeworkGenerateDetailRequest.childUserId = 0L;
  return self;
}
@end

@interface XCSDPBHomeworkGenerateDetailResponse ()
@property (strong) NSMutableArray * gameLevelsArray;
@end

@implementation XCSDPBHomeworkGenerateDetailResponse
...
static XCSDPBHomeworkGenerateDetailResponse* defaultXCSDPBHomeworkGenerateDetailResponseInstance = nil;
+ (void) initialize {
  if (self == [XCSDPBHomeworkGenerateDetailResponse class]) {
    defaultXCSDPBHomeworkGenerateDetailResponseInstance = [[XCSDPBHomeworkGenerateDetailResponse alloc] init];
  }
}
+ (instancetype) defaultInstance {
  return defaultXCSDPBHomeworkGenerateDetailResponseInstance;
}
- (instancetype) defaultInstance {
  return defaultXCSDPBHomeworkGenerateDetailResponseInstance;
}
...
+ (XCSDPBHomeworkGenerateDetailResponse*) parseFromData:(NSData*) data {
  return (XCSDPBHomeworkGenerateDetailResponse*)[[[XCSDPBHomeworkGenerateDetailResponse builder] mergeFromData:data] build];
}
+ (XCSDPBHomeworkGenerateDetailResponse*) parseFromData:(NSData*) data extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (XCSDPBHomeworkGenerateDetailResponse*)[[[XCSDPBHomeworkGenerateDetailResponse builder] mergeFromData:data extensionRegistry:extensionRegistry] build];
}
+ (XCSDPBHomeworkGenerateDetailResponse*) parseFromInputStream:(NSInputStream*) input {
  return (XCSDPBHomeworkGenerateDetailResponse*)[[[XCSDPBHomeworkGenerateDetailResponse builder] mergeFromInputStream:input] build];
}
+ (XCSDPBHomeworkGenerateDetailResponse*) parseFromInputStream:(NSInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (XCSDPBHomeworkGenerateDetailResponse*)[[[XCSDPBHomeworkGenerateDetailResponse builder] mergeFromInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (XCSDPBHomeworkGenerateDetailResponse*) parseFromCodedInputStream:(PBCodedInputStream*) input {
  return (XCSDPBHomeworkGenerateDetailResponse*)[[[XCSDPBHomeworkGenerateDetailResponse builder] mergeFromCodedInputStream:input] build];
}
+ (XCSDPBHomeworkGenerateDetailResponse*) parseFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (XCSDPBHomeworkGenerateDetailResponse*)[[[XCSDPBHomeworkGenerateDetailResponse builder] mergeFromCodedInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (XCSDPBHomeworkGenerateDetailResponseBuilder*) builder {
  return [[XCSDPBHomeworkGenerateDetailResponseBuilder alloc] init];
}
+ (XCSDPBHomeworkGenerateDetailResponseBuilder*) builderWithPrototype:(XCSDPBHomeworkGenerateDetailResponse*) prototype {
  return [[XCSDPBHomeworkGenerateDetailResponse builder] mergeFrom:prototype];
}
- (XCSDPBHomeworkGenerateDetailResponseBuilder*) builder {
  return [XCSDPBHomeworkGenerateDetailResponse builder];
}
- (XCSDPBHomeworkGenerateDetailResponseBuilder*) toBuilder {
  return [XCSDPBHomeworkGenerateDetailResponse builderWithPrototype:self];
}
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  [self.gameLevelsArray enumerateObjectsUsingBlock:^(XCSDPBGameLevel *element, NSUInteger idx, BOOL *stop) {
    [output appendFormat:@"%@%@ {\n", indent, @"gameLevels"];
...
- (BOOL) isEqual:(id)other {
  ...
  if (![other isKindOfClass:[XCSDPBHomeworkGenerateDetailResponse class]]) {
    return NO;
  }
  XCSDPBHomeworkGenerateDetailResponse *otherMessage = other;
  return
      [self.gameLevelsArray isEqualToArray:otherMessage.gameLevelsArray] &&
      (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
@interface XCSDPBHomeworkGenerateDetailResponseBuilder()
@property (strong) XCSDPBHomeworkGenerateDetailResponse* resultHomeworkGenerateDetailResponse;
@end

@implementation XCSDPBHomeworkGenerateDetailResponseBuilder
@synthesize resultHomeworkGenerateDetailResponse;
- (instancetype) init {
  if ((self = [super init])) {
    self.resultHomeworkGenerateDetailResponse = [[XCSDPBHomeworkGenerateDetailResponse alloc] init];
  }
  return self;
}
- (PBGeneratedMessage*) internalGetResult {
  return resultHomeworkGenerateDetailResponse;
}
- (XCSDPBHomeworkGenerateDetailResponseBuilder*) clear {
  self.resultHomeworkGenerateDetailResponse = [[XCSDPBHomeworkGenerateDetailResponse alloc] init];
  return self;
}
- (XCSDPBHomeworkGenerateDetailResponseBuilder*) clone {
  return [XCSDPBHomeworkGenerateDetailResponse builderWithPrototype:resultHomeworkGenerateDetailResponse];
}
- (XCSDPBHomeworkGenerateDetailResponse*) defaultInstance {
  return [XCSDPBHomeworkGenerateDetailResponse defaultInstance];
}
- (XCSDPBHomeworkGenerateDetailResponse*) build {
  [self checkInitialized];
  return [self buildPartial];
}
- (XCSDPBHomeworkGenerateDetailResponse*) buildPartial {
  XCSDPBHomeworkGenerateDetailResponse* returnMe = resultHomeworkGenerateDetailResponse;
  self.resultHomeworkGenerateDetailResponse = nil;
  return returnMe;
}
- (XCSDPBHomeworkGenerateDetailResponseBuilder*) mergeFrom:(XCSDPBHomeworkGenerateDetailResponse*) other {
  if (other == [XCSDPBHomeworkGenerateDetailResponse defaultInstance]) {
    return self;
  }
  if (other.gameLevelsArray.count > 0) {
    if (resultHomeworkGenerateDetailResponse.gameLevelsArray == nil) {
      resultHomeworkGenerateDetailResponse.gameLevelsArray = [[NSMutableArray alloc] initWithArray:other.gameLevelsArray];
    } else {
      [resultHomeworkGenerateDetailResponse.gameLevelsArray addObjectsFromArray:other.gameLevelsArray];
    }
  }
  [self mergeUnknownFields:other.unknownFields];
  return self;
}
- (XCSDPBHomeworkGenerateDetailResponseBuilder*) mergeFromCodedInputStream:(PBCodedInputStream*) input {
  return [self mergeFromCodedInputStream:input extensionRegistry:[PBExtensionRegistry emptyRegistry]];
}
- (XCSDPBHomeworkGenerateDetailResponseBuilder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  PBUnknownFieldSetBuilder* unknownFields = [PBUnknownFieldSet builderWithUnknownFields:self.unknownFields];
  while (YES) {
    SInt32 tag = [input readTag];
    switch (tag) {
...
- (NSMutableArray *)gameLevels {
  return resultHomeworkGenerateDetailResponse.gameLevelsArray;
}
- (XCSDPBGameLevel*)gameLevelsAtIndex:(NSUInteger)index {
  return [resultHomeworkGenerateDetailResponse gameLevelsAtIndex:index];
}
- (XCSDPBHomeworkGenerateDetailResponseBuilder *)addGameLevels:(XCSDPBGameLevel*)value {
  if (resultHomeworkGenerateDetailResponse.gameLevelsArray == nil) {
    resultHomeworkGenerateDetailResponse.gameLevelsArray = [[NSMutableArray alloc]init];
  }
  [resultHomeworkGenerateDetailResponse.gameLevelsArray addObject:value];
  return self;
}
- (XCSDPBHomeworkGenerateDetailResponseBuilder *)setGameLevelsArray:(NSArray *)array {
  resultHomeworkGenerateDetailResponse.gameLevelsArray = [[NSMutableArray alloc]initWithArray:array];
  return self;
}
- (XCSDPBHomeworkGenerateDetailResponseBuilder *)clearGameLevels {
  resultHomeworkGenerateDetailResponse.gameLevelsArray = nil;
  return self;
}
@end

@interface XCSDPBSendUnifiedHomeworkRequest ()
@property SInt64 classId;
@property (strong) NSMutableArray * gameLevelsArray;
@end

@implementation XCSDPBSendUnifiedHomeworkRequest
...
static XCSDPBSendUnifiedHomeworkRequest* defaultXCSDPBSendUnifiedHomeworkRequestInstance = nil;
+ (void) initialize {
  if (self == [XCSDPBSendUnifiedHomeworkRequest class]) {
    defaultXCSDPBSendUnifiedHomeworkRequestInstance = [[XCSDPBSendUnifiedHomeworkRequest alloc] init];
  }
}
+ (instancetype) defaultInstance {
  return defaultXCSDPBSendUnifiedHomeworkRequestInstance;
}
- (instancetype) defaultInstance {
  return defaultXCSDPBSendUnifiedHomeworkRequestInstance;
}
...
+ (XCSDPBSendUnifiedHomeworkRequest*) parseFromData:(NSData*) data {
  return (XCSDPBSendUnifiedHomeworkRequest*)[[[XCSDPBSendUnifiedHomeworkRequest builder] mergeFromData:data] build];
}
+ (XCSDPBSendUnifiedHomeworkRequest*) parseFromData:(NSData*) data extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (XCSDPBSendUnifiedHomeworkRequest*)[[[XCSDPBSendUnifiedHomeworkRequest builder] mergeFromData:data extensionRegistry:extensionRegistry] build];
}
+ (XCSDPBSendUnifiedHomeworkRequest*) parseFromInputStream:(NSInputStream*) input {
  return (XCSDPBSendUnifiedHomeworkRequest*)[[[XCSDPBSendUnifiedHomeworkRequest builder] mergeFromInputStream:input] build];
}
+ (XCSDPBSendUnifiedHomeworkRequest*) parseFromInputStream:(NSInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (XCSDPBSendUnifiedHomeworkRequest*)[[[XCSDPBSendUnifiedHomeworkRequest builder] mergeFromInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (XCSDPBSendUnifiedHomeworkRequest*) parseFromCodedInputStream:(PBCodedInputStream*) input {
  return (XCSDPBSendUnifiedHomeworkRequest*)[[[XCSDPBSendUnifiedHomeworkRequest builder] mergeFromCodedInputStream:input] build];
}
+ (XCSDPBSendUnifiedHomeworkRequest*) parseFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (XCSDPBSendUnifiedHomeworkRequest*)[[[XCSDPBSendUnifiedHomeworkRequest builder] mergeFromCodedInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (XCSDPBSendUnifiedHomeworkRequestBuilder*) builder {
  return [[XCSDPBSendUnifiedHomeworkRequestBuilder alloc] init];
}
+ (XCSDPBSendUnifiedHomeworkRequestBuilder*) builderWithPrototype:(XCSDPBSendUnifiedHomeworkRequest*) prototype {
  return [[XCSDPBSendUnifiedHomeworkRequest builder] mergeFrom:prototype];
}
- (XCSDPBSendUnifiedHomeworkRequestBuilder*) builder {
  return [XCSDPBSendUnifiedHomeworkRequest builder];
}
- (XCSDPBSendUnifiedHomeworkRequestBuilder*) toBuilder {
  return [XCSDPBSendUnifiedHomeworkRequest builderWithPrototype:self];
}
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  if (self.hasClassId) {
    [output appendFormat:@"%@%@: %@\n", indent, @"classId", [NSNumber numberWithLongLong:self.classId]];
...
- (BOOL) isEqual:(id)other {
  ...
  if (![other isKindOfClass:[XCSDPBSendUnifiedHomeworkRequest class]]) {
    return NO;
  }
  XCSDPBSendUnifiedHomeworkRequest *otherMessage = other;
  return
      self.hasClassId == otherMessage.hasClassId &&
      (!self.hasClassId || self.classId == otherMessage.classId) &&
      [self.gameLevelsArray isEqualToArray:otherMessage.gameLevelsArray] &&
...
@interface XCSDPBSendUnifiedHomeworkRequestBuilder()
@property (strong) XCSDPBSendUnifiedHomeworkRequest* resultSendUnifiedHomeworkRequest;
@end

@implementation XCSDPBSendUnifiedHomeworkRequestBuilder
@synthesize resultSendUnifiedHomeworkRequest;
- (instancetype) init {
  if ((self = [super init])) {
    self.resultSendUnifiedHomeworkRequest = [[XCSDPBSendUnifiedHomeworkRequest alloc] init];
  }
  return self;
}
- (PBGeneratedMessage*) internalGetResult {
  return resultSendUnifiedHomeworkRequest;
}
- (XCSDPBSendUnifiedHomeworkRequestBuilder*) clear {
  self.resultSendUnifiedHomeworkRequest = [[XCSDPBSendUnifiedHomeworkRequest alloc] init];
  return self;
}
- (XCSDPBSendUnifiedHomeworkRequestBuilder*) clone {
  return [XCSDPBSendUnifiedHomeworkRequest builderWithPrototype:resultSendUnifiedHomeworkRequest];
}
- (XCSDPBSendUnifiedHomeworkRequest*) defaultInstance {
  return [XCSDPBSendUnifiedHomeworkRequest defaultInstance];
}
- (XCSDPBSendUnifiedHomeworkRequest*) build {
  [self checkInitialized];
  return [self buildPartial];
}
- (XCSDPBSendUnifiedHomeworkRequest*) buildPartial {
  XCSDPBSendUnifiedHomeworkRequest* returnMe = resultSendUnifiedHomeworkRequest;
  self.resultSendUnifiedHomeworkRequest = nil;
  return returnMe;
}
- (XCSDPBSendUnifiedHomeworkRequestBuilder*) mergeFrom:(XCSDPBSendUnifiedHomeworkRequest*) other {
  if (other == [XCSDPBSendUnifiedHomeworkRequest defaultInstance]) {
    return self;
  }
  if (other.hasClassId) {
    [self setClassId:other.classId];
  ...
  if (other.gameLevelsArray.count > 0) {
    if (resultSendUnifiedHomeworkRequest.gameLevelsArray == nil) {
      resultSendUnifiedHomeworkRequest.gameLevelsArray = [[NSMutableArray alloc] initWithArray:other.gameLevelsArray];
    } else {
      [resultSendUnifiedHomeworkRequest.gameLevelsArray addObjectsFromArray:other.gameLevelsArray];
    }
  }
  [self mergeUnknownFields:other.unknownFields];
  return self;
}
- (XCSDPBSendUnifiedHomeworkRequestBuilder*) mergeFromCodedInputStream:(PBCodedInputStream*) input {
  return [self mergeFromCodedInputStream:input extensionRegistry:[PBExtensionRegistry emptyRegistry]];
}
- (XCSDPBSendUnifiedHomeworkRequestBuilder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  PBUnknownFieldSetBuilder* unknownFields = [PBUnknownFieldSet builderWithUnknownFields:self.unknownFields];
  while (YES) {
    SInt32 tag = [input readTag];
    switch (tag) {
...
- (BOOL) hasClassId {
  return resultSendUnifiedHomeworkRequest.hasClassId;
}
- (SInt64) classId {
  return resultSendUnifiedHomeworkRequest.classId;
}
- (XCSDPBSendUnifiedHomeworkRequestBuilder*) setClassId:(SInt64) value {
  resultSendUnifiedHomeworkRequest.hasClassId = YES;
  resultSendUnifiedHomeworkRequest.classId = value;
  return self;
}
- (XCSDPBSendUnifiedHomeworkRequestBuilder*) clearClassId {
  resultSendUnifiedHomeworkRequest.hasClassId = NO;
  resultSendUnifiedHomeworkRequest.classId = 0L;
  return self;
}
- (NSMutableArray *)gameLevels {
  return resultSendUnifiedHomeworkRequest.gameLevelsArray;
}
- (XCSDPBGameLevel*)gameLevelsAtIndex:(NSUInteger)index {
  return [resultSendUnifiedHomeworkRequest gameLevelsAtIndex:index];
}
- (XCSDPBSendUnifiedHomeworkRequestBuilder *)addGameLevels:(XCSDPBGameLevel*)value {
  if (resultSendUnifiedHomeworkRequest.gameLevelsArray == nil) {
    resultSendUnifiedHomeworkRequest.gameLevelsArray = [[NSMutableArray alloc]init];
  }
  [resultSendUnifiedHomeworkRequest.gameLevelsArray addObject:value];
  return self;
}
- (XCSDPBSendUnifiedHomeworkRequestBuilder *)setGameLevelsArray:(NSArray *)array {
  resultSendUnifiedHomeworkRequest.gameLevelsArray = [[NSMutableArray alloc]initWithArray:array];
  return self;
}
- (XCSDPBSendUnifiedHomeworkRequestBuilder *)clearGameLevels {
  resultSendUnifiedHomeworkRequest.gameLevelsArray = nil;
  return self;
}
@end

@interface XCSDPBSendUnifiedHomeworkResponse ()
@end

@implementation XCSDPBSendUnifiedHomeworkResponse
...
static XCSDPBSendUnifiedHomeworkResponse* defaultXCSDPBSendUnifiedHomeworkResponseInstance = nil;
+ (void) initialize {
  if (self == [XCSDPBSendUnifiedHomeworkResponse class]) {
    defaultXCSDPBSendUnifiedHomeworkResponseInstance = [[XCSDPBSendUnifiedHomeworkResponse alloc] init];
  }
}
+ (instancetype) defaultInstance {
  return defaultXCSDPBSendUnifiedHomeworkResponseInstance;
}
- (instancetype) defaultInstance {
  return defaultXCSDPBSendUnifiedHomeworkResponseInstance;
}
...
+ (XCSDPBSendUnifiedHomeworkResponse*) parseFromData:(NSData*) data {
  return (XCSDPBSendUnifiedHomeworkResponse*)[[[XCSDPBSendUnifiedHomeworkResponse builder] mergeFromData:data] build];
}
+ (XCSDPBSendUnifiedHomeworkResponse*) parseFromData:(NSData*) data extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (XCSDPBSendUnifiedHomeworkResponse*)[[[XCSDPBSendUnifiedHomeworkResponse builder] mergeFromData:data extensionRegistry:extensionRegistry] build];
}
+ (XCSDPBSendUnifiedHomeworkResponse*) parseFromInputStream:(NSInputStream*) input {
  return (XCSDPBSendUnifiedHomeworkResponse*)[[[XCSDPBSendUnifiedHomeworkResponse builder] mergeFromInputStream:input] build];
}
+ (XCSDPBSendUnifiedHomeworkResponse*) parseFromInputStream:(NSInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (XCSDPBSendUnifiedHomeworkResponse*)[[[XCSDPBSendUnifiedHomeworkResponse builder] mergeFromInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (XCSDPBSendUnifiedHomeworkResponse*) parseFromCodedInputStream:(PBCodedInputStream*) input {
  return (XCSDPBSendUnifiedHomeworkResponse*)[[[XCSDPBSendUnifiedHomeworkResponse builder] mergeFromCodedInputStream:input] build];
}
+ (XCSDPBSendUnifiedHomeworkResponse*) parseFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (XCSDPBSendUnifiedHomeworkResponse*)[[[XCSDPBSendUnifiedHomeworkResponse builder] mergeFromCodedInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (XCSDPBSendUnifiedHomeworkResponseBuilder*) builder {
  return [[XCSDPBSendUnifiedHomeworkResponseBuilder alloc] init];
}
+ (XCSDPBSendUnifiedHomeworkResponseBuilder*) builderWithPrototype:(XCSDPBSendUnifiedHomeworkResponse*) prototype {
  return [[XCSDPBSendUnifiedHomeworkResponse builder] mergeFrom:prototype];
}
- (XCSDPBSendUnifiedHomeworkResponseBuilder*) builder {
  return [XCSDPBSendUnifiedHomeworkResponse builder];
}
- (XCSDPBSendUnifiedHomeworkResponseBuilder*) toBuilder {
  return [XCSDPBSendUnifiedHomeworkResponse builderWithPrototype:self];
}
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  [self.unknownFields writeDescriptionTo:output withIndent:indent];
}
...
- (BOOL) isEqual:(id)other {
  ...
  if (![other isKindOfClass:[XCSDPBSendUnifiedHomeworkResponse class]]) {
    return NO;
  }
  XCSDPBSendUnifiedHomeworkResponse *otherMessage = other;
  return
      (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
- (NSUInteger) hash {
...
@interface XCSDPBSendUnifiedHomeworkResponseBuilder()
@property (strong) XCSDPBSendUnifiedHomeworkResponse* resultSendUnifiedHomeworkResponse;
@end

@implementation XCSDPBSendUnifiedHomeworkResponseBuilder
@synthesize resultSendUnifiedHomeworkResponse;
- (instancetype) init {
  if ((self = [super init])) {
    self.resultSendUnifiedHomeworkResponse = [[XCSDPBSendUnifiedHomeworkResponse alloc] init];
  }
  return self;
}
- (PBGeneratedMessage*) internalGetResult {
  return resultSendUnifiedHomeworkResponse;
}
- (XCSDPBSendUnifiedHomeworkResponseBuilder*) clear {
  self.resultSendUnifiedHomeworkResponse = [[XCSDPBSendUnifiedHomeworkResponse alloc] init];
  return self;
}
- (XCSDPBSendUnifiedHomeworkResponseBuilder*) clone {
  return [XCSDPBSendUnifiedHomeworkResponse builderWithPrototype:resultSendUnifiedHomeworkResponse];
}
- (XCSDPBSendUnifiedHomeworkResponse*) defaultInstance {
  return [XCSDPBSendUnifiedHomeworkResponse defaultInstance];
}
- (XCSDPBSendUnifiedHomeworkResponse*) build {
  [self checkInitialized];
  return [self buildPartial];
}
- (XCSDPBSendUnifiedHomeworkResponse*) buildPartial {
  XCSDPBSendUnifiedHomeworkResponse* returnMe = resultSendUnifiedHomeworkResponse;
  self.resultSendUnifiedHomeworkResponse = nil;
  return returnMe;
}
- (XCSDPBSendUnifiedHomeworkResponseBuilder*) mergeFrom:(XCSDPBSendUnifiedHomeworkResponse*) other {
  if (other == [XCSDPBSendUnifiedHomeworkResponse defaultInstance]) {
    return self;
  }
  [self mergeUnknownFields:other.unknownFields];
  return self;
}
- (XCSDPBSendUnifiedHomeworkResponseBuilder*) mergeFromCodedInputStream:(PBCodedInputStream*) input {
  return [self mergeFromCodedInputStream:input extensionRegistry:[PBExtensionRegistry emptyRegistry]];
}
- (XCSDPBSendUnifiedHomeworkResponseBuilder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  PBUnknownFieldSetBuilder* unknownFields = [PBUnknownFieldSet builderWithUnknownFields:self.unknownFields];
  while (YES) {
    SInt32 tag = [input readTag];
    switch (tag) {
