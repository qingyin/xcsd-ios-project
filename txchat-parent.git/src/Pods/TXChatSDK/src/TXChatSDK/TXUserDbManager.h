...
@property (nonatomic, readonly) XCSDHomeWorkDao *homeWorkDao;
@property (nonatomic, readonly) XCSDTestDao *testDao;
@property (nonatomic, readonly) XCSDCourseDao *courseDao;
@property(nonatomic, readonly) XCSDDataReportDao *dataReportDao;
