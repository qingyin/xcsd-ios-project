...
NSString *const kAUMediaPlayerPlayItemIsLoadingNotification = @"kAUMediaPlayerPlayItemIsLoadingNotification";
NSString *const kAUMediaPlayerPlayItemIsLoadingNotificationUserInfoKey = @"kAUMediaPlayerPlayItemIsLoadingNotificationUserInfoKey";
