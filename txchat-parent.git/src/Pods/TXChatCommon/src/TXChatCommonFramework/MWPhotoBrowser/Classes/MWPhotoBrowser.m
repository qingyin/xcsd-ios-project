...
- (void)setControlsHidden:(BOOL)hidden animated:(BOOL)animated permanent:(BOOL)permanent {
    ...
    if (hidden && _delegate && [_delegate respondsToSelector:@selector(photoBrowser:singleTappedForPhotoAtIndex:)]) {
        [_delegate photoBrowser:self singleTappedForPhotoAtIndex:_currentPageIndex];
        return;
    }
    // Force visible
