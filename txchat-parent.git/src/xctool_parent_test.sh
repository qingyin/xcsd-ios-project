...
if [ ! -d ~/genPackage/IOS_Parent ];then
  mkdir -p ~/genPackage/IOS_Parent
fi
ROOT_PATH=~/genPackage/IOS_Parent
...
PROFILE_ADHOC="parentsClient_adHoc_new"
...
APP_ID="573587abf2fc42261e000000"
APP_TYPE="ios"
...
echo "成功上传到fir地址：http://fir.im/lxtParentIOSV1"
