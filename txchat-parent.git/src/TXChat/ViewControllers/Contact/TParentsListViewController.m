...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else
    {
        ...
        parentInfoCell.callBtn.hidden = YES;
        parentInfoCell.callBtn.enabled = NO;
        parentInfoCell.inviteBtn.hidden = YES;
        parentInfoCell.inviteBtn.enabled = NO;
        cell = parentInfoCell;
    }
    return cell;
}
