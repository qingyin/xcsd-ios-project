...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [classCell.classNameLabel setText:user.nickname];
    [classCell.classIconImageView TX_setImageWithURL:[NSURL URLWithString:[user getFormatAvatarUrl:40.0f hight:40.0f]] placeholderImage:[UIImage imageNamed:@"userDefaultIcon"]];
    [classCell.inActiveLabel setHidden:user.activated];
...
//    if([user.nicknameFirstLetter length] > 0)
//    {
//        [label setText:[user.nicknameFirstLetter substringToIndex:1]];
//    }
