...
- (void)fetchLocalPostGroupListWithMaxId:(int64_t)maxId
{
    ...
    //by zhang
//     NSArray *postGroups = [[TXChatClient sharedInstance].postManager queryPosts:(TXPBPostType)TXHomePostType_Activity maxPostId:maxId gardenId:_isGardenSubscription ? user.gardenId : 0 count:20 error:&error];
