...
//        cell.selectionStyle = UITableViewCellSelectionStyleNone;
        ...
        UIImageView *portraitImgView  = [[UIImageView alloc] initWithFrame:CGRectMake(13, (KCellHight-40.0f)/2, 40, 40)];
        ...
        UILabel *subTitleLb = [[UILabel alloc] initClearColorWithFrame:CGRectMake(0, (KCellHight-45.0f)/2, tableView.width_ - 14, 45)];
        ...
        invitationBtn.frame = CGRectMake(tableView.width_ - 14 - 60, (KCellHight-30.0f)/2, 60, 30);
        ...
        UIView *lineView = [[UIView alloc] initLineWithFrame:CGRectMake(14, KCellHight - kLineHeight, self.view.width_ - 14, kLineHeight)];
    ...
    [titleLb sizeToFit];
    titleLb.frame = CGRectMake(portraitImgView.maxX + 7, (KCellHight-45.0f)/2, titleLb.width_, 45);
    ...
    if (arr.count) {
        ...
        if (info.isMaster) {
            starView.hidden = NO;
            starView.frame = CGRectMake(titleLb.maxX + 7, (KCellHight-16.0f)/2, 16, 16);
        }
        titleLb.textColor = KColorAppMain;
        subTitleLb.text = info.user.mobile;
        [portraitImgView TX_setImageWithURL:[NSURL URLWithString:[info.user.avatar getFormatPhotoUrl:40 hight:40]] placeholderImage:[UIImage imageNamed:@"userDefaultIcon"]];
    }else{
