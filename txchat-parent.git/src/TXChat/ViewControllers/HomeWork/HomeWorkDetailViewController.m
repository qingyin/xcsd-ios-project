...
@interface HomeWorkDetailViewController ()<UIGestureRecognizerDelegate, NotifyFromViewDelegate>
{
...
-(void)setupViews
{
    ...
    //    [fromView.fromLabel setBackgroundColor:[UIColor clearColor]];
