...
- (void)initView{
    ...
    UIImage *logoImg = [UIImage imageNamed:@"logo_parent"];
    ...
    _nameTextField.font = [UIFont systemFontOfSize:15 * kScale1];
    ...
    _pwdTextField.font = [UIFont systemFontOfSize:15 * kScale1];
    ...
    _loginBtn.titleLabel.font = [UIFont systemFontOfSize:16 * kScale1];
    _loginBtn.layer.cornerRadius = 4.f;
    _loginBtn.layer.masksToBounds = YES;
    _loginBtn.enabled = NO;
    [_loginBtn setTitle:@"登录" forState:UIControlStateNormal];
    [_loginBtn setTitleColor:kColorWhite forState:UIControlStateNormal];
    [_loginBtn setBackgroundImage:[UIImageView createImageWithColor:kColorType] forState:UIControlStateNormal];
    ...
    activeBtn.titleLabel.font = [UIFont systemFontOfSize:15 * kScale1];
    activeBtn.layer.cornerRadius = 4.f;
    activeBtn.layer.masksToBounds = YES;
    activeBtn.layer.borderColor = kColorType.CGColor;
    ...
    [activeBtn setBackgroundImage:[UIImageView createImageWithColor:RGBCOLOR(230, 247, 255)] forState:UIControlStateHighlighted];
    [activeBtn setTitle:@"注册" forState:UIControlStateNormal];
    [activeBtn setTitleColor:kColorType forState:UIControlStateNormal];
    ...
    findPwdBtn.titleLabel.font = [UIFont systemFontOfSize:15 * kScale1];
    ...
    if ([TXSystemManager sharedManager].isDevVersion) {
        ...
        debugBtn.titleLabel.font = [UIFont systemFontOfSize:15 * kScale1];
