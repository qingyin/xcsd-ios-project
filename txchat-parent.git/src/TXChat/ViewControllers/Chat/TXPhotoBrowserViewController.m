...
//    __weak typeof(self)tmpObject = self;
    ...
    [[TXChatClient sharedInstance].departmentPhotoManager fetchDepartmentPhotos:user.classId maxDepartmentPhotoId:photo.departmentPhotoId onCompleted:^(NSError *error, NSArray *txDepartmentPhotos,int64_t totalCount ,BOOL hasMore) {
