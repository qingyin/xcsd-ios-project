...
#define CATDayLabelWidth  (kScreenWidth - 40)/7
#define CATDayLabelHeight kScreenWidth/320 * 30.f
...
- (void)setup
{
    ...
    //月份
    UILabel *masterLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, kScreenWidth/320 * 35.f)];
    [masterLabel setBackgroundColor:[UIColor clearColor]];
    [masterLabel setTextAlignment:NSTextAlignmentCenter];
    [masterLabel setFont:kFontMiddle];
    self.masterLabel = masterLabel;
    self.masterLabel.textColor = COLOR_THEME;
    [self addSubview:self.masterLabel];
    
    [self addSubview:[[UIView alloc] initLineWithFrame:CGRectMake(0, masterLabel.maxY, kScreenWidth, kLineHeight)]];
    
    CGFloat xOffset = 5.0f;
    CGFloat yOffset = kScreenWidth/320 * 35;
    ...
    [dayOfTheWeekLabel setFont:kFontMiddle];
