//
//  BabyInfoNoParentTableViewCell.m
//  TXChatTeacher
//
...
#define KBaseColor  RGBCOLOR(0x49, 0x68, 0x77)

@interface BabyInfoNoParentTableViewCell()
{
    UIView *_beginView;
    UIView *_seperatorLine;
}
@end
@implementation BabyInfoNoParentTableViewCell
