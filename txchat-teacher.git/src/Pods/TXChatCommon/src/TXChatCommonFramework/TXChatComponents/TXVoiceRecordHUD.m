...
@implementation TXVoiceRecordHUD
...
- (void)configRecordingHUDImageWithPeakPower:(CGFloat)peakPower {
    NSString *imageName = @"TXChatList.bundle/RecordingSignal00";
...
- (void)setup {
    ...
    if (!_microPhoneImageView) {
        ...
        microPhoneImageView.image = [UIImage imageNamed:@"TXChatList.bundle/RecordingBkg"];
    ...
    if (!_recordingHUDImageView) {
        ...
        recordHUDImageView.image = [UIImage imageNamed:@"TXChatList.bundle/RecordingSignal001"];
    ...
    if (!_cancelRecordImageView) {
        ...
        cancelRecordImageView.image = [UIImage imageNamed:@"TXChatList.bundle/RecordCancel"];
