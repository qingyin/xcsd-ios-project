...
//            CGFloat max_height = 120;
            ...
            self.bubbleView.frame = CGRectMake(self.cellWidth - (kMessageAvatarWidth + kMessageAvatarAndBubbleMargin + kMessageCellSpace) - max_width, kMessageViewMargin, max_width, [data rowHeight] + 20);
            return;
        }
