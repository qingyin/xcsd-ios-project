...
- (void)updateIndicators {
    ...
    else if (mode == MBProgressHUDModeNone) {
        //没有indicator,Edit by 爱彬
        self.indicator = nil;
    }
...
- (void)layoutSubviews {
    ...
    if (nil != self.labelText) {
        ...
        labelParagraphStyle.lineBreakMode = label.lineBreakMode;
        labelParagraphStyle.alignment = NSTextAlignmentCenter;
        NSDictionary * labelAttributes = @{NSFontAttributeName : label.font,
        ...
        CGSize dims;
//        if (IOS7_OR_LATER) {
//            dims = [self.labelText sizeWithAttributes:labelAttributes];
//        }else{
//            dims = [self.labelText sizeWithFont:label.font];
//        }
        dims = [self.labelText sizeWithAttributes:labelAttributes];
        ...
        CGSize labelSize;
//        if (IOS7_OR_LATER) {
//            labelSize = [self.labelText boundingRectWithSize:CGSizeMake(lWidth, MAXFLOAT)
//                                                     options:(NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading)
//                                                  attributes:labelAttributes
//                                                     context:nil].size;
//        }else {
//            NSAttributedString *str = [[NSAttributedString alloc] initWithString:self.labelText];
//            labelSize = [str boundingRectWithSize:CGSizeMake(lWidth, MAXFLOAT) options:(NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading) context:nil].size;
//        }
        labelSize = [self.labelText boundingRectWithSize:CGSizeMake(lWidth, MAXFLOAT)
                                                 options:(NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading)
                                              attributes:labelAttributes
        ...
        lFrame = CGRectMake((CGRectGetWidth(frame) - lWidth) / 2, CGRectGetMaxY(indFrame), lWidth, lHeight);
        label.frame = lFrame;
