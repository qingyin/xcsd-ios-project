...
////static NSString *[TXApplicationManager sharedInstance].currentToken = @"cd070eff111e4e40862746b52067734e";
//static NSString *[TXApplicationManager sharedInstance].currentToken = @"09d5d432c11846fd9521e8ecd541e173";
...
//    [[TXApplicationManager sharedInstance] currentToken];
    [[TXHttpClient sharedInstance] sendRequest:@"/fetch_course_lesson_list"
                                   ...
                                   onCompleted:^(NSError *error, TXPBResponse *response) {
                                    ...
                                    TXPBFetchCourseLessonListResponse *txpbFetchCourseListResponse;
                                       ...
                                       [[TXApplicationManager sharedInstance].currentUserDbManager.courseDao deleteAllCourses];
