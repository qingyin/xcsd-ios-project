...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  if (self.hasOsName) {
    [output writeString:5 value:self.osName];
  }
  if (self.hasOsVersion) {
    [output writeString:6 value:self.osVersion];
  }
...
- (SInt32) serializedSize {
  ...
  if (self.hasOsName) {
    size_ += computeStringSize(5, self.osName);
  }
  if (self.hasOsVersion) {
    size_ += computeStringSize(6, self.osVersion);
  }
...
- (BOOL) hasOsName {
  return resultRequest.hasOsName;
}
- (NSString*) osName {
  return resultRequest.osName;
}
- (TXPBRequestBuilder*) setOsName:(NSString*) value {
  resultRequest.hasOsName = YES;
  resultRequest.osName = value;
  return self;
}
- (TXPBRequestBuilder*) clearOsName {
  resultRequest.hasOsName = NO;
  resultRequest.osName = @"";
  return self;
}
- (BOOL) hasOsVersion {
  return resultRequest.hasOsVersion;
}
- (NSString*) osVersion {
  return resultRequest.osVersion;
}
- (TXPBRequestBuilder*) setOsVersion:(NSString*) value {
  resultRequest.hasOsVersion = YES;
  resultRequest.osVersion = value;
  return self;
}
- (TXPBRequestBuilder*) clearOsVersion {
  resultRequest.hasOsVersion = NO;
  resultRequest.osVersion = @"";
  return self;
}
@end
