...
BOOL XCSDPBEventTypeIsValidValue(XCSDPBEventType value) {
  switch (value) {
    ...
    case XCSDPBEventTypeLessonScore:
    case XCSDPBEventTypeFinishHomework:
    case XCSDPBEventTypeGameTest:
    case XCSDPBEventTypeEnterBackground:
    case XCSDPBEventTypeEnterForeground:
    case XCSDPBEventTypeReadNotice:
      return YES;
    default:
      return NO;
  }
...
NSString *NSStringFromXCSDPBEventType(XCSDPBEventType value) {
  switch (value) {
    ...
    case XCSDPBEventTypeLessonScore:
      return @"XCSDPBEventTypeLessonScore";
    case XCSDPBEventTypeFinishHomework:
      return @"XCSDPBEventTypeFinishHomework";
    case XCSDPBEventTypeGameTest:
      return @"XCSDPBEventTypeGameTest";
    case XCSDPBEventTypeEnterBackground:
      return @"XCSDPBEventTypeEnterBackground";
    case XCSDPBEventTypeEnterForeground:
      return @"XCSDPBEventTypeEnterForeground";
    case XCSDPBEventTypeReadNotice:
      return @"XCSDPBEventTypeReadNotice";
    default:
      return nil;
  }
}
