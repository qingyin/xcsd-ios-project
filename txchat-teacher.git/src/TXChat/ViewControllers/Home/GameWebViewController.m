...
//    _window = [[UIWindow alloc]initWithFrame:CGRectMake(CGRectGetWidth(self.view.frame)*4/5, CGRectGetHeight(self.view.frame)/10-50, 50, 50)];
...
//    [_window makeKeyAndVisible];//关键语句,显示window
    ...
    _button.frame = CGRectMake(CGRectGetWidth(self.view.frame)-51, CGRectGetHeight(self.view.frame)/10+10, 50, 50);
...
- (void)loadFoundWebContentData
{
    ...
    requestUrl = [KURL_H5_HOST stringByAppendingString:[NSString stringWithFormat:@"?action=10001&memberId=%lld",user.userId]];
