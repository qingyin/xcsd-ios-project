...
@interface ZLBaseTableViewController ()<UITableViewDataSource,UITableViewDelegate>
...
- (void)viewDidLoad{
    ...
    self.tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, self.customNavigationView.maxY, self.view.width_, self.view.height_ - self.customNavigationView.height_) style:UITableViewStylePlain];
    _tableView.delegate = self;
    _tableView.dataSource = self;
    _tableView.showsHorizontalScrollIndicator = NO;
    _tableView.showsVerticalScrollIndicator = NO;
    if (IOS7_OR_LATER) {
        _tableView.sectionIndexBackgroundColor = kColorClear;
    }
...
- (NSString *)tableView:(UITableView *)tableView
    ...
    if ((NSInteger)[(NSArray *)[self.partitionedContacts
