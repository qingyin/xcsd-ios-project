...
typedef NS_ENUM(NSInteger, HomeListType) {
    ...
    HomeListType_SignIn,                    //签到记录
    HomeListType_Attendance,                //考勤
    HomeListType_Address,                   //通讯录
    HomeListType_VoiceSpeak,                //语音播报
    
    HomeListType_HomeWork,           //学能作业
    HomeListType_CeatherCommunity, // 教师社区
    HomeListType_Game,                      //游戏 by mey
    HomeListType_Achievement,               //学能成绩 by mey
    HomeListType_ThemeTest,                 // 测试
...
typedef NS_ENUM(NSInteger, FoundType) {
    ...
    FoundType_TeacherHelp,                 //教师帮
    FoundType_RuleExplain,                 //规则说明
