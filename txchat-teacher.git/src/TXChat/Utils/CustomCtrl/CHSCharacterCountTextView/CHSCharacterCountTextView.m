...
#define KPlacehoderTextColor RGBCOLOR(0xbb, 0xbb, 0xbb)
...
- (void)setPlaceholderColor:(UIColor *)placeholderColor
{
    ...
    [messageTextView setTextColor:_placeholderColor];
}

- (void)setPlaceholderFont:(UIFont *)placeholderFont
{
    _placeholderFont = placeholderFont;
    [messageTextView setFont:_placeholderFont];
}
-(void)layoutSubviews
{
...
-(void)textViewDidEndEditing:(UITextView *)textView {
	...
	if([[textView text] length] == 0 && !showingPlaceholder) {
        ...
        [textView setTextColor:_placeholderColor ?: KPlacehoderTextColor];
