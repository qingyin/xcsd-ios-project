...
- (void)awakeFromNib
{
    ...
    [_contentLabel setTextColor:kColorGray1];
    _contentLabel.numberOfLines = 2;
    [_contentLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(self.mas_left).with.offset(60.0f);
        make.top.mas_equalTo(self).with.offset(kEdgeInsetsLeft);
    ...
    [_headerImageview mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.mas_equalTo(self).with.offset(kEdgeInsetsLeft);
        make.bottom.mas_equalTo(self).with.offset(-kEdgeInsetsLeft);
