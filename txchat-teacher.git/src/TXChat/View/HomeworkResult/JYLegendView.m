...
//	CGContextFillRoundedRect(c, self.bounds, LEGEND_ROUND_RADIUS);
	...
	for (int i = 0; i < self.titles.count; i++) {
        ...
        [title drawAtPoint:CGPointMake(COLOR_PADDING + PADDING, y + PADDING) withAttributes:@{NSForegroundColorAttributeName : RGBCOLOR(145, 145, 145), NSFontAttributeName : [UIFont systemFontOfSize:10]}];
