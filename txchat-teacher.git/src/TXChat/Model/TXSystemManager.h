...
extern NSString * const kChatListLastCommunionTime;
extern NSString * const kChatListHasCommunionFlag;
 ...
 *  刷卡语音播放是否播放中
 */
@property (nonatomic,getter=isCheckInVoiceSpeaking) BOOL checkInVoiceSpeaking;

@property (nonatomic,assign) TXMediaPlayNetworkType mediaNetworkType;
